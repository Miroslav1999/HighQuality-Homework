namespace AssertionsHomework
{
    ...
    public class Program
    {
        ...
        {
            Debug.Assert(arr.Length > 0, "Array should not be empty.");
            Debug.Assert(startIndex >= 0, "Start index should be greater than or equal to zero.");
            Debug.Assert(startIndex < arr.Length - 1, "Start index should be smaller than array size - 1.");
            Debug.Assert(startIndex <= endIndex, "Start index should be smaller than end index.");
            Debug.Assert(endIndex >= 0, "End index should be greater than or equal to zero.");
